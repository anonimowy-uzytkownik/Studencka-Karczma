...
public class PrzepisListAdapterUlubione  extends ArrayAdapter<Przepis> {
    private static final String TAG = "PrzepisListAdapter";

    private Context mContext;
    int mResource;

    public PrzepisListAdapterUlubione(android.content.Context context, int resource, ArrayList<Przepis> objects) {
